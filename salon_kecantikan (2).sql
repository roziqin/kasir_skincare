...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2019 at 04:14 PM
...
(3, 'Acne Series', 2, 150000, 300000, 0, 0, 0, 1, 29, 5, 0, ''),
(4, 'Tes', 3, 0, 60000, 0, 0, 0, 0, 0, 0, 0, ''),
(5, 'Glow Series', 2, 0, 100000, 0, 0, 0, 1, 6, 5, 0, '');
...
(11, 2, '2019-11-19 19:24:17', '0000-00-00 00:00:00'),
(12, 3, '2019-11-19 21:40:39', '2019-11-19 21:43:25'),
(13, 3, '2019-11-19 21:43:37', '2019-11-19 21:47:51'),
(14, 3, '2019-11-19 21:48:00', '0000-00-00 00:00:00');
...
(24, '2019-11-19', '19:25:26', '2019-11', 0, 300000, 0, 0, 0, 300000, 'cash', 2, 4, 'TES', ''),
(25, '2019-11-19', '20:07:42', '2019-11', 2, 100000, 0, 0, 0, 100000, 'debet', 2, 5, '', ''),
(26, '2019-11-19', '21:49:41', '2019-11', 4, 150000, 50000, 0, 0, 150000, 'debet', 3, 7, '', ''),
(27, '2019-11-19', '21:59:28', '2019-11', 2, 375000, 0, 0, 0, 400000, 'cash', 3, 4, '', '');
...
(25, 24, 3, 300000, 150000, 0, 1, 300000, '', 0, 2),
(26, 25, 5, 100000, 0, 0, 1, 100000, '', 0, 2),
(27, 26, 5, 100000, 0, 0, 2, 200000, '', 0, 3),
(28, 27, 3, 300000, 150000, 0, 1, 300000, '', 0, 3),
(29, 27, 5, 75000, 0, 0, 1, 75000, '', 0, 3);
...
(17, '2019-11-19', '21:39:49', 2, 'Admin', 200000, 300000, 100000, 400000),
(18, '2019-11-19', '22:00:09', 3, 'kasir', 100000, 375000, 150000, 525000);
...
--
ALTER TABLE `log_user`
  MODIFY `log_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `member_temp`
  MODIFY `member_temp_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `transaksi`
  MODIFY `transaksi_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `transaksi_detail`
--
ALTER TABLE `transaksi_detail`
  MODIFY `transaksi_detail_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `transaksi_detail_temp`
--
ALTER TABLE `transaksi_detail_temp`
  MODIFY `transaksi_detail_temp_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `validasi`
  MODIFY `validasi_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
